...
public class ExpressionTest extends BaseTest {
    ...
    @Override
    protected void test() throws OverflowException, DivisionByZeroException {
    ...
    private void testExpression(final String description, final Expression actual, final Expression expected) throws OverflowException, DivisionByZeroException {
    ...
    private Integer evaluate(final Expression expression, final int x) throws OverflowException, DivisionByZeroException {
        try {
