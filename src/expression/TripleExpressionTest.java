...
public class TripleExpressionTest extends ExpressionTest {
    ...
    private void testExpression(final String description, final TripleExpression actual, final TripleExpression expected) throws OverflowException, DivisionByZeroException {
